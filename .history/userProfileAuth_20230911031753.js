...
document.addEventListener("DOMContentLoaded", function () {
    // Find elements with the class "my-class"// const elements = document.getElementsByClassName("my-class");
...
function userAuthFun(){
    firebase.auth().onAuthStateChanged(function (users) {
        ...
        const signinSignupVisibility =document.getElementsByClassName("signIn-signup-visibility");
        if (users) {
