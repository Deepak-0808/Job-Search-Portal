...
function updateProfile1() {
  ...
  if (user) {
    ...
    // Reference to the user's data at users/${uid}/
    ...
    userRef.once("value", function (snapshot) {
      ...
      if (userData) {
        ...
        // document.getElementById("skills").textContent = userData.skills || "N/A";
      } else {
  ...
  // Function to update the profile with user data
  function updateProfile(userData) {
    if (userData) {
      document.getElementById("username").textContent =userData.userna || "N/A";
      document.getElementById("email").textContent = userData.email || "N/A";
      document.getElementById("location").textContent =userData.location || "N/A";
      document.getElementById("skills").textContent = userData.skills || "N/A";
    } else {
...
firebase.auth().onAuthStateChanged(function (user) {
  if (user) {
    ...
    // User is not signed in, you can handle this case here
    // Clear the profile data or show a sign-in button
    userRef = null;
    updateProfile(null);
  }
});
