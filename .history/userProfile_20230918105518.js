...
document.getElementById("resume-upload-form").addEventListener("submit", function (e) {
  ...
  if (file) {
    ...
    const storageRef = firebase.storage().ref("resumes/" + file.name);
      ...
      () => {
        ...
        uploadTask.snapshot.ref.getDownloadURL().then((downloadURL) => {
          ...
          const resumeData = {
            ...
            // You can include other resume information here if needed
          };
          
          // Push the resume data to the Realtime Database
          const databaseRef = firebase.database().ref("resumes");
          databaseRef.push(resumeData);
        });
      }
    );
  }
