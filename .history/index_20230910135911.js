...
let jobLocation = "India";
let employment_types = "";

const callPrams = (event) => {
  // calling Loader
  showLoader();
  alert("after show loder");
  if(event.btn.checked.cl)
                ...
                <section class="h-auto ml-10 flex justify-between">
                    ...
                    <div id="meal" style="width:900px;" class="flex-row   ">
                        <div class="h-auto m-10 bg-white rounded-2xl shadow-2xl ">
                            ...
                            <button id="jobSavebtn" class="bg-slate-100 p-4 rounded-lg flex cursor-pointer">
