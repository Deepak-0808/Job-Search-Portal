...
function addEducationEntry(event) {
  ...
  // Retrieve values from the form
  const levelOrStandard = document.getElementById("role").value;
  const university = document.getElementById("company").value;
  const completionDate = document.getElementById("duration-date").value;
