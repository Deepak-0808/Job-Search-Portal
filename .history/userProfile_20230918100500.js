...
// Initialize Firebase (your-firebase-config.js should contain Firebase configuration)
...
// Replace 'uid' with the actual user's UID

var uploadButton = document.getElementById('upload-resume-button');
...
uploadButton.addEventListener('click', function(e) {
    ...
    var sanitizedFileName = file.name.replace(/[.#$[\]]/g, '');
    
    // Get a reference to the storage service
var storage = firebase.storage();

// Create a reference to the PDF file in storage
var pdfRef = storage.ref().child('pdfs/myfile.pdf');

// Put the PDF file into storage
pdfRef.put(yourPdfFile).then(function(snapshot) {
...
// var uid = 'replace_with_actual_uid';
// var storage = firebase.storage();
// var resumeFileInput = document.getElementById('resume-file');
// var uploadButton = document.getElementById('upload-resume-button');
...
//     var storageRef = storage.ref(`users/${uid}/profile/resume/${sanitizedFileName}`);
...
//             database.ref(`users/${uid}/profile/resume`).set(downloadURL);
//         });
//     });
// });
