          ...
          .then(function (snapshot) {
            ...
            if (userData && userData.title) {
              // Display the user's name
                // projectTitle.textContent = userData.title;
                // collegeName.textContent=userData.institution;
                // date.textContent=userData.completionDate;
                // description.textContent=userData.description;
            let  projectTitle1 = userData.title;
            let  collegeName1 = userData.institution;
            let date1 = userData.completionDate;
            let description1 = userData.description;
            projectTitle2=projectTitle1;
            collegeName2=collegeName1;
            date2=date2;
